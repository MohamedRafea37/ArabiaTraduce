...
| See you later  | Hasta luego   | AH-sta loo-EH-go |

## Introducing yourself

To say your name in Spanish, use:
...
**Spanish:** Hola, me llamo David.

You can also use:

| Spanish      | English              |
| ------------ | -------------------- |
| Soy David.   | I am David.          |
...
**Person B:** Me llamo Carlos. ¿Y tú?

**Person A:** Me llamo Sarah. Mucho gusto.
...
Many words ending in **-o** are masculine.
